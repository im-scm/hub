...
# Página: Procurement Control Tower
# Salvar este arquivo dentro da pasta pages/ do SCM Analytics Hub.
# Sugestão de nome: 03_Compras_Control_Tower.py
...
st.set_page_config(page_title="Compras Control Tower", layout="wide")

APP_TITLE = "Compras Control Tower"
...
# Links de referência para o hub. Ajuste os caminhos se os nomes finais forem diferentes.
with st.sidebar:
    st.markdown("### Navegação do Hub")
    try:
        ...
        st.markdown("- 🏠 Home")
        st.markdown("- 🔎 Cockpit Papel")
        st.markdown("- 📈 Paper Base")
    st.divider()
...
tab_control, tab_follow, tab_suppliers, tab_abc_sup, tab_abc_items, tab_buyers, tab_pmp, tab_price, tab_radar = st.tabs([
    "🏠 Control Tower",
    "📦 Follow-up",
    "🏭 Fornecedores",
    "📊 ABC Fornecedores",
