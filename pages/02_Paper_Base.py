...
.pb-kpi-label {font-size:.78rem; color:#6B7280; margin-bottom:6px;}.pb-kpi-value {font-size:1.16rem; font-weight:700; color:#111827; line-height:1.2;}
.pb-table-shell {border:1px solid #E5E7EB; border-radius:14px; background:#FFF; overflow:hidden; box-shadow:0 1px 2px rgba(0,0,0,.03);}.pb-table-wrap {overflow-y:auto; overflow-x:auto;}
.pb-table {width:100%; border-collapse:separate; border-spacing:0; table-layout:auto; font-size:.84rem; color:#111827;}.pb-table thead th {position:sticky; top:0; z-index:2; background:#F9FAFB; color:#6B7280; font-weight:600; border-bottom:1px solid #E5E7EB; border-right:1px solid #F0F2F5; padding:8px 10px; white-space:nowrap;}
.pb-table tbody td {padding:7px 10px; border-bottom:1px solid #F3F4F6; border-right:1px solid #F8FAFC; white-space:nowrap; background:#FFF;}.pb-table tbody tr:hover td {background:#FAFBFF;}
...
with st.sidebar:
    st.markdown("### Filtros"); st.caption(APP_VERSION); st.divider()
