...
def home():
    ...
    st.markdown(
        "<div class='hub-note'>Use a navegação da barra lateral para abrir os dashboards.</div>",
        unsafe_allow_html=True,
    )


# Sidebar branding. O st.navigation abaixo adiciona os links reais na mesma barra lateral.
with st.sidebar:
