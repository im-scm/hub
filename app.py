...
# Logo nativa do Streamlit: aparece acima do menu multipágina nativo.
...
st.markdown(
    "<div class='hub-note'>A logo agora é aplicada via <b>st.logo()</b>, ficando acima do menu nativo multipágina.</div>",
    unsafe_allow_html=True,
)
