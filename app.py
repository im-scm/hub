...
# O arquivo existente no seu repositório está em assets/impress_im_weiss_blau.png
LOGO_PATH = "assets/impress_im_weiss_blau.png"
...
with st.sidebar:
    ...
    st.caption("Use a navegação nativa do Streamlit na barra lateral para abrir as páginas.")
    st.divider()
    st.caption("Arquivos Excel esperados na raiz do repositório:")
    ...
    st.markdown(
        ...
        <div class='hub-card'>
          ...
          <div class='hub-card-text'>
            ...
            Abra pelo menu lateral nativo do Streamlit.
          </div>
...
st.markdown(
    "<div class='hub-note'>Esta versão não usa st.switch_page nem st.page_link. A navegação fica 100% com o mecanismo nativo multipágina do Streamlit.</div>",
    unsafe_allow_html=True,
)
